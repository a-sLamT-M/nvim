...
local config = {
	...
	cmd = {
		...
		-- TODO Update this to point to the correct jdtls subdirectory for your OS (config_lnux, config_mac, config_win, etc)
		...
		java = {
			...
			configuration = {
				...
				runtimes = {
					{
						name = "JavaSE-8",
						path = "/usr/lib/nvim-jdk/java-8-openjdk-amd64",
					},
				}
			},
			maven = {
